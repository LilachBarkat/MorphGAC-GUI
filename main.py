...
------------------------------------
This work provide a GUI for a Semi-automated segmentation.
as part of the
the code is based on the MorphGAC algorithm [2].
...
.. [2] A Morphological Approach to Curvature-based Evolution of Curves and
       Surfaces, Pablo Márquez-Neila, Luis Baumela and Luis Álvarez. In IEEE
       Transactions on Pattern Analysis and Machine Intelligence (PAMI),
       2014, DOI 10.1109/TPAMI.2013.106
"""
...
class GUI:
    ...
    def one_image(self):
        ...
        self.igg_img = inverse_gaussian_gradient(img, alpha=100, sigma=1.48)
